				...
				_createClass(_class, [{
					...
					*/
					...
					value: function renderControls(data) {
						...
						}, [(0, _h2.default)('header', [this.name]), (0, _h2.default)('div.button-group.tiny', [(0, _h2.default)('span.button.btn-mute' + muteClass, {
							onclick: function onclick() {
								_this2.ee.emit('mute', _this2);
							}
						}, ['Mute']), (0, _h2.default)('span.button.btn-solo' + soloClass, {
							onclick: function onclick() {
